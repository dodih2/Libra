...
$nama_member = mysqli_query($koneksi, "SELECT nama FROM user WHERE id_member='$id_member'");
...
<html>
<head>
	<title>Halaman Member : [<?php echo $data['nama'];?>]</title>
</head>
<body>
<h1>Selamat Datang [<?php echo $data['nama'];?>] di halaman Member</h1>

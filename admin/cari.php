...
<div class='row'>
<?php
	$tampil = mysqli_query($conn, "SELECT * FROM buku WHERE judul_buku like '%$_POST[cari]%' OR deskripsi LIKE '%$_POST[cari]%' ORDER BY id_buku DESC");
...
while($c=mysqli_fetch_array($tampil)){
	...
	echo "Upss Buku Nya gak ada Hikss :'("; 
}
echo "</div>";
?>
</div>
